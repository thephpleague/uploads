...
class FileInfoTest extends PHPUnit_Framework_TestCase
{
    ...
    {
        $this->fileWithExtension = new \League\Uploads\FileInfo(dirname(__FILE__) . '/assets/foo.txt', 'foo.txt');
        $this->fileWithoutExtension = new \League\Uploads\FileInfo(dirname(__FILE__) . '/assets/foo_wo_ext', 'foo_wo_ext');
    }
